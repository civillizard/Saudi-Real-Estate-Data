...
<p align="center">
  <a href="https://www.6ra3.com/track/r/rega-site-data-dictionary?dest=https://rega.gov.sa"><img src="https://www.6ra3.com/track/rega/data-dictionary" height="50" alt="REGA - Real Estate General Authority (الهيئة العامة للعقار)"></a>
  &nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://www.6ra3.com/track/r/moj-site-data-dictionary?dest=https://moj.gov.sa"><img src="https://www.6ra3.com/track/moj/data-dictionary" height="50" alt="MOJ - Ministry of Justice (وزارة العدل)"></a>
</p>
...
- **JSON** (for AI tools and APIs): [`data/schema.json`](../data/schema.json) (compact, 80 KB) and [`data/registry.json`](../data/registry.json) (full, 478 KB)
- **CSV** (for pandas, Excel, SQL): [`data/registry_files.csv`](../data/registry_files.csv), [`data/registry_fields.csv`](../data/registry_fields.csv), [`data/registry_enums.csv`](../data/registry_enums.csv)
- **SQLite**: `registry.db` (rebuild with `python3 scripts/build_registry.py`)
...
### JSON (for AI tools and APIs)

| File | Size | Description |
|------|------|-------------|
| [`data/schema.json`](../data/schema.json) | 80 KB | Compact schema: one entry per category with field union, data types, enum values, date formats, and a canonical field index. Designed for feeding into Claude, ChatGPT, Gemini, or any LLM/agent context |
| [`data/registry.json`](../data/registry.json) | 478 KB | Full registry: every file with all fields, sample values, null counts, min/max values, region coverage. Use when you need per-file detail |
      ...
      "fields": [
        {
          ...
          "in_files": "24/24",
          "nullable": false,
          "enum_values": [{"value": "منطقة الرياض", "count": 477347}, ...]
        },
        ...
      ]
    },
